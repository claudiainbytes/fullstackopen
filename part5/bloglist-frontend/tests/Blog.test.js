...
describe('<Blog />', () => {
  ...
  test('render title and author, not url or likes', () => {
    ...
    const blogToggle = container.getElementsByClassName('blog-container-toggle')
  ...
  test('render blog url and likes when toggle button is clicked', async () => {
    ...
    const url = screen.getByText('https://www.example.com/effective-project-management-tips')
